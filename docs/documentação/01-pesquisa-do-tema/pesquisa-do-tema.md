...
## Tema
Plataforma web de agendamento multidisciplinar para treinamento, saúde e bem-estar.
...
1. pesquisar profissionais;
2. consultar disponibilidade;
3. agendar, reagendar ou cancelar atendimentos;
4. visualizar uma agenda integrada;
5. receber lembretes;
6. acompanhar seus próximos atendimentos.
